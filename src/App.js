import logo from './visual-studio.svg';
import './App.css';
...
return (
  ...
  <label for="company-focus">Company focus?</label><br />
  <select name="company-focus" id="cf">
  ...
  return (
    ...
    <div className='OutsideLogin' >Do you have an account? <a href="url">Sign in</a></div>
